...
function showRaceModal(race) {
    // Реализация модального окна расы (остается без изменений)
    const raceData = {
        hell: {
            title: 'АДСКАЯ РАСА',
            description: 'Повелители огня и тьмы из глубин Незера',
            abilities: ['🔥 Огнестойкость', '🌋 Лавовые способности', '⚡ Скорость в аду'],
            color: '#ff4444'
        },
        heaven: {
            title: 'РАЙСКАЯ РАСА',
            description: 'Хранители света и небес из Энда',
            abilities: ['🕊️ Полёт', '✨ Магия света', '🌤️ Небесное преимущество'],
            color: '#4fc3f7'
        },
        earth: {
            title: 'ЗЕМНАЯ РАСА',
            description: 'Мастера строительства и природы Оверворлда',
            abilities: ['🏗️ Усиленное строительство', '🌱 Фермерский буст', '💪 Выносливость'],
            color: '#8bc34a'
        }
    };
