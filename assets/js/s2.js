        ...
        function getSettlementInfo(name) {
            const settlements = {
                'ФрикБургская Империя': {
                    ...
                    race: 'Земные',
                    raceIcon: '<img src="assets/images/icons/icon_terrestrial.gif" class="resized-image_map2">',
                    leader: '_Kot_Baris_',
                    population: 8,
                    location: 'Земля',
                },
                'Логово Хантера': {
                    name: 'Логово Хантера',
                    race: 'Демоны',
                    raceIcon: '<img src="assets/images/icons/icon_demon.gif" class="resized-image_map">',
                ...
                'База Ангелов': {
                    name: 'База Ангелов',
                    race: 'Ангелы',
                    raceIcon: '<img src="assets/images/icons/icon_angel.gif" class="resized-image_map">',
                ...
                'Максимка': {
                    name: 'Максимка',
                    race: 'Земные',
                    raceIcon: '<img src="assets/images/icons/icon_terrestrial.gif" class="resized-image2">',
                    leader: 'maxxaumka',
                    population: 1,
                    location: 'Земля',
                }
